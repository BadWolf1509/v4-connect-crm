  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        />
        <StatCard title="Automações" value="5" change="0%" icon={<Zap className="h-5 w-5" />} />
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-xl border border-gray-800 bg-gray-900/50 p-6">
          ...
          <div className="space-y-4">
            {['Maria', 'João', 'Ana', 'Pedro'].map((name, index) => (
              <div key={name} className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm text-gray-400">{[12, 8, 15, 6][index]} conversas</span>
                  </div>
                  <div className="mt-1 h-2 w-full rounded-full bg-gray-800">
                    <div
                      className="h-2 rounded-full bg-v4-red-500"
                      style={{ width: `${[75, 60, 90, 45][index]}%` }}
                    />
                  </div>
                </div>
              </div>
  ...
  return (
    <div className="rounded-xl border border-gray-800 bg-gray-900/50 p-6">
      <div className="flex items-center justify-between">
        ...
        <span className={`text-sm font-medium ${isPositive ? 'text-green-500' : 'text-gray-500'}`}>
          {change}
        </span>
      </div>
      <div className="mt-4">
